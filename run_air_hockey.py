...
if __name__ == '__main__':
    ...
    # Optional arguments
    parser.add_argument("-p1", "--player1", default='player_B', help="Enter Player1 file url without .py extension")
    parser.add_argument("-p2", "--player2", default='player_Z', help="Enter Player2 file url without .py extension")
